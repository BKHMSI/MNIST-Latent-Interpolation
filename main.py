...
class MemNet:
    def __init__(self):
        ...
        self.y_train = y_train[:self.memsize]
    ...
    def latent_interpolation(self, model_path, out_path, out_name, n_steps, imsize, start_num, end_num):
...
if __name__ == "__main__":
    ...
    if args.generate:
        memnet.latent_interpolation(model_path=args.model_path, out_path=args.out_path, out_name=args.out_name, 
            n_steps=args.n_steps, imsize=args.imsize, start_num=args.start_num, end_num=args.end_num)